            ...
            <form class="forms-sample" action="{{ route('admin.departments.index') }}" method="get">
                <div class="row align-items-center">
                        ...
                        <select class="form-select form-select-lg" name="branch">
                            ...
                            @foreach ($branch as $key => $value)
                                <option value="{{ $value->id }}"
                                    {{ isset($filterParameters['branch']) && $value->id == $filterParameters['branch'] ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-2 col-md-6 d-md-flex">
                        ...
                        <a class="btn btn-block btn-primary me-md-2 me-0 mb-4 form-control"
                            href="{{ route('admin.departments.index') }}">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div class="table-responsive">
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ ($departments->currentPage() - 1) * \App\Models\Department::RECORDS_PER_PAGE + ++$key }}
                                </td>
                                ...
                                <td class="text-center">
                                    <label class="switch">
                                        <input class="toggleStatus"
                                            href="{{ route('admin.departments.toggle-status', $value->id) }}"
