<div class="row">
    <input type="hidden" name="procurement_items" id="procurement_items"
        value="{{ json_encode($procurementDetail->procurement_items) }}">

    {{-- <input type="hidden" name="procurement_items[{{ $key }}][id]" value="{{ $item->id ?? '' }}"> --}}


    <div class="row mb-3">
        <h3 class="card-header text-danger" style="margin-bottom: 30px !important;">Edit Procurement&nbsp;<svg
    ...
    <div class="row mb-3">
        <h3 class="card-header text-danger" style="margin-bottom: 30px !important;">Edit Asset&nbsp;<svg
        ...
        <div class="col-md-3"> <label for="quantity" class="form-label">Quantity&nbsp;<span
            ...
            <input type="number" class="form-control" name="quantity" id="quantity" placeholder="Enter Amount">
        </div>
        <div class="col-md-3">
            <label for="quantity" class="form-label">Specification&nbsp;<span class="text-danger">*</span></label>
            <textarea class="form-control" name="specification" id="specification" cols="15" rows="2"
    ...
    <div class="row mb-3">
        <div class="col-md-12 text-end">
            <button type="button" class="btn btn-primary text-light" id="addItem">Add</button>
        </div>
    </div>
        ...
        <div class="row mb-3" style="margin-top: 100px !important;">
            <div class="col-md-12 text-end">
                <button type="submit" class="btn btn-success">
                    <i class="link-icon" data-feather="plus"></i>Update</button>
            </div>
        </div>
    @endcanany
