                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                                            <ul class="list-unstyled p-1 mb-0">
                                                ...
                                                @can('make_employee_as_admin')
                                                    <li class="dropdown-item py-2">
                                                        <a class="adminEmployee"
                                                            data-href="{{ route('admin.users.makeadminasuser', $value->id) }}">
                                                            <button class="btn btn-primary btn-xs">Make As Admin</button>
                                                        </a>
                                                    </li>
                                                @endcan
